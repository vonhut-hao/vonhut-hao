...
| **DevOps & Infra** | Docker, Terraform, Git, CI/CD (GitHub Actions) |
| **Cloud Services** | AWS (VPC, IAM, S3, CloudFront, ECS, ECR, Lambda, MediaConvert) |
| **Environment** | Linux (Fedora/Ubuntu), Windows 11 |
